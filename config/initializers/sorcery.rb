...
Rails.application.config.sorcery.submodules = [:external, :brute_force_protection]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.callback_url = "http://localhost:3007/oauth/callback?provider=facebook"
  ...
  #
   config.vk.key = "4715276"
   config.vk.secret = "fRjetuFrFwapcGHX5NK4"
   config.vk.callback_url = "http://localhost:3007/oauth/callback?provider=vk"
   config.vk.user_info_mapping = {:email => "full_name"}
  #
